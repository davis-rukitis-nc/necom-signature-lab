...
const INTRO_STORAGE_KEY = "necom-email-signature-lab-tour-v3";
  ...
  en: [
    {
      ...
      body: "Start here: choose NECom or an event. The logo, colors, website and info text update in one click.",
      bullets: ["+ creates a custom brand.", "The minimal logo is selected by default."],
      target: "#presetGrid",
      placement: "right",
    },
    {
      title: "Add the person.",
      body: "Type the name, title, phone and email. The preview updates instantly, so this is where most people should start.",
      bullets: ["Show the email address only when it is needed.", "Check long names and emails in Mobile preview."],
      target: ".editor-tab-panel[data-tab-panel='content'] .editor-card",
      tab: "content",
      placement: "right",
    },
    {
      title: "Style the signature.",
      body: "Open Style to choose Left border or Top border, adjust width, text color and the website link color.",
    ...
    },
    {
      ...
      body: "Start with the prepared brand colors. Use the custom picker only for non-brand cases.",
    ...
    {
      title: "Make it mobile safe.",
      body: "In Layout, choose visible rows and how contact details should behave. Stacked rows are safest for Gmail on phones.",
      bullets: ["One line is useful for compact desktop signatures.", "Stacked rows are better for long emails and mobile safety."],
    ...
    },
    {
      ...
      body: "Switch between Desktop and Mobile before copying. Use New email to test different real-looking email lengths.",
      bullets: ["Mobile preview catches contact wrapping issues fastest.", "New email helps spot awkward spacing."],
      target: ".gmail-actions",
      placement: "left",
    },
    {
      title: "Copy for Gmail.",
      body: "Use Copy for Gmail, then paste into Gmail signature settings. Copy HTML is mostly for technical checks.",
      bullets: ["Send yourself one test email before using it daily.", "For normal team use, choose Copy for Gmail."],
      target: ".copy-tray",
      placement: "top",
    },
  ],
  lv: [
    {
      ...
      body: "Sāc šeit: izvēlies NECom vai pasākumu. Logo, krāsas, mājaslapa un info teksts nomainās ar vienu klikšķi.",
      bullets: ["+ izveido pielāgotu zīmolu.", "Minimālais logo ir izvēlēts pēc noklusējuma."],
      target: "#presetGrid",
      placement: "right",
    },
    {
      title: "Pievieno personu.",
      body: "Ievadi vārdu, amatu, telefonu un e-pastu. Priekšskatījums atjaunojas uzreiz, tāpēc šī ir galvenā darba vieta.",
      bullets: ["E-pasta adresi rādi tikai tad, ja tā vajadzīga.", "Garus vārdus un e-pastus pārbaudi mobilajā skatā."],
      target: ".editor-tab-panel[data-tab-panel='content'] .editor-card",
      tab: "content",
      placement: "right",
    },
    {
      title: "Noformē parakstu.",
      body: "Atver Stilu, lai izvēlētos Kreiso malu vai Augšējo malu, platumu, teksta krāsu un mājaslapas saites krāsu.",
    ...
    },
    {
      ...
      body: "Sāc ar sagatavotajām zīmola krāsām. Pielāgoto krāsu lieto tikai īpašos ārpus zīmola gadījumos.",
      bullets: ["Akcenta krāsa kontrolē līnijas un galvenās detaļas.", "Mājaslapas saites krāsa ir atsevišķa kontrastam."],
      target: "#accentPalette",
      tab: "style",
      placement: "right",
    },
    {
      title: "Sakārto mobilo skatu.",
      body: "Sadaļā Rindas izvēlies redzamās rindas un kontaktu izkārtojumu. Rindās ir drošākā izvēle Gmail telefonā.",
      bullets: ["Vienā rindā der kompaktam desktop parakstam.", "Rindās ir labāk gariem e-pastiem un mobilajai drošībai."],
      target: "#contactLayoutButton",
      tab: "layout",
      placement: "right",
    },
    {
      title: "Pārbaudi pirms kopēšanas.",
      body: "Pirms kopēšanas pārslēdz Dators un Mobilais. Jauns epasts palīdz testēt dažādus e-pasta garumus.",
      bullets: ["Mobilais skats visātrāk parāda kontaktu aplaušanas problēmas.", "Jauns epasts palīdz pamanīt neveiklas atstarpes."],
      target: ".gmail-actions",
      placement: "left",
    },
    {
      title: "Kopē Gmail.",
      body: "Izmanto Kopēt Gmail un ielīmē Gmail paraksta iestatījumos. Kopēt HTML vairāk domāts tehniskai pārbaudei.",
      bullets: ["Pirms ikdienas lietošanas nosūti sev testa e-pastu.", "Komandas ikdienai izmanto Kopēt Gmail."],
      target: ".copy-tray",
      placement: "top",
    },
  ],
